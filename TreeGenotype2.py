...
class treeGenotype:
    ...
    def __init__(self, depth_limit = 3, hyper=None, gene = None, popSize=random.randint(20,50), tag = 'og', influx=random.randint(8,20),mr = random.random(), temp=random.randint(5,15),in_nodes=['+','-','*','/','max','min','avg'], le_nodes=['A','L','H','C','B','M','#.#']):
        self.fitness = 0
        self.gene = gene
